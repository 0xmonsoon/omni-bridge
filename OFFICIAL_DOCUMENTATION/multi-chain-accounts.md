...
![chain-signatures](https://docs.near.org/assets/docs/welcome-pages/chain-signatures-overview.png)
...
Our example [implementation](https://docs.near.org/chain-abstraction/chain-signatures/implementation) shows you how to sign transactions for: Bitcoin, Solana, Cosmos, XRP, Aptos, Sui and EVM networks (Ethereum, Base, BNB Chain, Avalanche, Polygon, Arbitrum, and more).
...
![Chain Signatures](https://docs.near.org/assets/docs/chain-abstraction/chain-abstract-2.svg)
...
After a request is made, the `sign` method will [yield execution](https://docs.near.org/blog/yield-resume) waiting while the [MPC signing service](#multi-party-computation-service) signs the transaction.
