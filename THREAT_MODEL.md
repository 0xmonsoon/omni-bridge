...
| Denial of Service      | **ETH Transfer Grief in finTransfer**         | For native ETH transfers (tokenAddress == 0), if recipient always reverts, the transfer is permanently stuck with no fallback mechanism.                                                                                           | `finTransfer` (ETH path)                      | **HIGH**     |
